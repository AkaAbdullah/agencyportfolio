        ...
        <Box>
            ...
            <Grid container spacing={2} sx={{ alignItems: "center" }}>
                <Grid item md={8} xxs={12}>
                    <Box>
                        <Grid container spacing={2}>
                            {data.Skill.awards.list &&
                                data.Skill.awards.list.map((award, i) => (
                ...
                <Grid item md={4} xxs={0} sx={{ display: { md: "unset", xxs: "none" } }}>
                    <Box>
                        <Typography variant="h5" component="h5" sx={styles.Title} dangerouslySetInnerHTML={{ __html: data.Skill.awards.title }} />
                    </Box>
                </Grid>
            </Grid>
        </Box>
